---
layout: page
title: Recurrent Neural Networks (RNN) · ML Foundations
description: Using RNNs to process sequential data (text, time-series, etc.).
image: /static/images/ml_foundations.png

course-url: /courses/ml-foundations/
next-lesson-url: /courses/ml-foundations/attention/
---
...
<h3 id="vanilla">Vanilla RNN</h3>
- [RNN](#rnn)
- [Model](#model_vanilla)
- [Training](#training_vanilla)
- [Evaluation](#evaluation_vanilla)
...
<h4 id="training_vanilla">Training</h4>
...
<h4 id="evaluation_vanilla">Evaluation</h4>
...
<h3 id="gated">Gated RNN</h3>
- [Bidirectional RNN](#birnn)
- [Model](#model_gated)
- [Training](#training_gated)
- [Evaluation](#evaluation_gated)
...
<h4 id="birnn">Bidirectional RNN</h4>
...
<h4 id="training_gated">Training</h4>
...
<h4 id="evaluation_gated">Evaluation</h4>
