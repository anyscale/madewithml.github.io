...
<div class="row mt-4">
    ...
    <div class="col-md-4 mb-md-0 mb-4">
        <div class="card h-100" style="max-width: 18rem;">
            ...
            <div class="card-body">
                <ul class="task-list">
                    <li class="task-list-item"><label class="task-list-control"><input type="checkbox" checked=""><span class="task-list-indicator"></span></label>  &nbsp;<i>Everything included in the Essential plan</i></li>
