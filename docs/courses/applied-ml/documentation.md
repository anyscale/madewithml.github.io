...
- `#!js documentation`: A rendered webpage that summarizes all the functions, classes, API calls, workflows, examples, etc. so we can view and traverse through the code base wihtout actually having to look at the code just yet.
...
:octicons-info-24: View our rendered documentation via GitHub pages → [here](https://gokumohandas.github.io/applied-ml/){:target="_blank"}.
