...
keywords: notebooks, jupyter, ipython, jupyterlab, python, mlops, machine learning
...
## Set up
1. Click on this link to open the accompanying [notebook](https://github.com/GokuMohandas/Made-With-ML/blob/main/notebooks/01_Notebooks.ipynb){:target="_blank"} for this lesson or create a blank one on [Google Colab](https://colab.research.google.com/){:target="_blank"}.
