...
<div class="ai-center-all">
    <img width="650" src="https://i.ibb.co/2gF0JkX/reformat.png" style="border-radius: 7px;">
</div>

Once we've made or approved the changes, we can commit again to ensure that all hooks are passed.

<div class="ai-center-all">
    <img width="650" src="https://i.ibb.co/XxkzJZs/commit.png" style="border-radius: 7px;">
</div>
