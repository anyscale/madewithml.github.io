...
<div class="ai-center-all">
    <img width="600" src="https://i.ibb.co/9ycQcpq/environments.png">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/pPfPvCt/status1.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/Y80qJpt/status2.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="450" src="https://i.ibb.co/wBPd24h/status3.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="400" src="https://i.ibb.co/S0zJxWw/status4.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/mqKFH27/branch.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="700" src="https://i.ibb.co/YdL8TCd/merge-gh.png">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/c1g4rkN/delete-branch.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="700" src="https://i.ibb.co/6WnTGQ1/resolve.png">
</div>
...
<div class="ai-center-all">
    <img width="350" src="https://i.ibb.co/6XgfGvj/conflict-gh.png">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/HNqH499/merge.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/nsfchCL/stash.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/6bNtZpb/rebase.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/dmbbFPG/conflict-vs.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/RSWr9RC/apply.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/LJpqFWk/drop.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="1000" src="https://i.ibb.co/VDvG2gT/squash.png">
</div>
...
```
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/C822BLh/log.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="350" src="https://i.ibb.co/QKsXdfH/diff.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/D44Vccn/blame.png" style="border-radius: 7px;">
</div>
...
<div class="ai-center-all">
    <img width="1000" src="https://i.ibb.co/P1pjBD0/reset.png">
</div>
...
<div class="ai-center-all">
    <img width="1000" src="https://i.ibb.co/r38KthH/revert.png">
</div>
...
<div class="ai-center-all">
    <img width="550" src="https://i.ibb.co/HnbyWS8/checkout.png" style="border-radius: 7px;">
</div>
